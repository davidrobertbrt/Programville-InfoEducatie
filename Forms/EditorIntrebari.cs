    ...
    public partial class EditorIntrebari : Form
    {
        ...
        private void SalvareIntrebare()
        {
            if (intrebareCr == null)
            {
                ...
                {
                    string path = PhotoManager.SaveImage(picImagineCerinta.Image, "PicturesQuestions", intrebareCr.IdTest);
                    intrebareCr.CaleImagine = path;
                }
        ...
        private void NavigareIntrebare(int pos)
        {
            ...
            if (!String.IsNullOrWhiteSpace(intrebareCr.CaleImagine))
                picImagineCerinta.Image = PhotoManager.LoadImage(intrebareCr.CaleImagine);
            else
                picImagineCerinta.Image = null;
        ...
        private void btnLoadImagine_Click(object sender, EventArgs e)
        {
            ...
            {
                picImagineCerinta.Image = new Bitmap(open.FileName);
            }
        }
    }
}
